...
val WHITE_SLEEPING_BAG = register(Identifier(MOD_ID, "white_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val ORANGE_SLEEPING_BAG = register(Identifier(MOD_ID, "orange_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val MAGENTA_SLEEPING_BAG = register(Identifier(MOD_ID, "magenta_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val LIGHT_BLUE_SLEEPING_BAG = register(Identifier(MOD_ID, "light_blue_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val YELLOW_SLEEPING_BAG = register(Identifier(MOD_ID, "yellow_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val LIME_SLEEPING_BAG = register(Identifier(MOD_ID, "lime_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val PINK_SLEEPING_BAG = register(Identifier(MOD_ID, "pink_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val GRAY_SLEEPING_BAG = register(Identifier(MOD_ID, "gray_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val LIGHT_GRAY_SLEEPING_BAG = register(Identifier(MOD_ID, "light_gray_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val CYAN_SLEEPING_BAG = register(Identifier(MOD_ID, "cyan_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val BLUE_SLEEPING_BAG = register(Identifier(MOD_ID, "sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val PURPLE_SLEEPING_BAG = register(Identifier(MOD_ID, "purple_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val GREEN_SLEEPING_BAG = register(Identifier(MOD_ID, "green_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val BROWN_SLEEPING_BAG = register(Identifier(MOD_ID, "brown_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val RED_SLEEPING_BAG = register(Identifier(MOD_ID, "red_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
val BLACK_SLEEPING_BAG = register(Identifier(MOD_ID, "black_sleeping_bag"), SleepingBag(Settings().rarity(Rarity.RARE)))
