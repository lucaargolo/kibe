...
val INFINITE_FIRE_RESISTENCE: PlayerAbility = registerEffect(Pal.registerAbility(ModIdentifier("magma_ability")) { ability: PlayerAbility?, player: PlayerEntity? ->
    SimpleAbilityTracker(ability, player)
}, StatusEffects.FIRE_RESISTANCE)

val INFINITE_WATER_BREATHING: PlayerAbility = registerEffect(Pal.registerAbility(ModIdentifier("water_ability")) { ability: PlayerAbility?, player: PlayerEntity? ->
    SimpleAbilityTracker(ability, player)
