...
private fun appendItems(): List<ItemStack> {
    ...
    val order = arrayOf(
        ...
        VOID_BUCKET, WOODEN_BUCKET, WATER_WOODEN_BUCKET, SLIME_BOOTS, SLIME_SLING, COOLER, BIG_TORCH, CHUNK_LOADER, STONE_SPIKES, IRON_SPIKES, GOLD_SPIKES, DIAMOND_SPIKES,
