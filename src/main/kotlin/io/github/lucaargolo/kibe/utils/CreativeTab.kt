...
private fun appendItems(): List<ItemStack> {
    ...
    val order = arrayOf(
        ...
        ENTANGLED_CHEST, ENTANGLED_BAG, ENTANGLED_TANK, ENTANGLED_BUCKET, FLUID_HOPPER, BREAKER, PLACER, IGNITER,
        ...
        VOID_BUCKET, WOODEN_BUCKET, WATER_WOODEN_BUCKET, SLIME_BOOTS, SLIME_SLING, TORCH_SLING, ESCAPE_ROPE, COOLER, BIG_TORCH, HEAT_LAMP, DEHUMIDIFIER, CHUNK_LOADER, STONE_SPIKES, IRON_SPIKES, GOLD_SPIKES, DIAMOND_SPIKES,
