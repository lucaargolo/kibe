...
fun initCreativeTab() {
    val order = arrayOf(
        ...
        MAGNET, DIAMOND_RING, ANGEL_RING, MAGMA_RING, WATER_RING, LIGHT_RING,
        ...
        SLIME_BOOTS, SLIME_SLING, SLEEPING_BAG, CHUNK_LOADER, IRON_SPIKES, DIAMOND_SPIKES, REGULAR_CONVEYOR_BELT, FAST_CONVEYOR_BELT, EXPRESS_CONVEYOR_BELT,
