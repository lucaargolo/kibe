...
class ConveyorBelt(private val speed: Double): Block(FabricBlockSettings.of(Material.METAL, MapColor.IRON).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)) {
