...
class FluidHopperBlockEntity(pos: BlockPos, state: BlockState): SyncableBlockEntity(BlockEntityCompendium.FLUID_HOPPER, pos, state) {
    ...
    companion object {
        ...
        fun getFluidStorage(be: FluidHopperBlockEntity, dir: Direction?): Storage<FluidVariant> {
            return be.tank
        }
