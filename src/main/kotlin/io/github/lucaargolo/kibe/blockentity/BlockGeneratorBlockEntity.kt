...
class BlockGeneratorBlockEntity: SyncableBlockEntity, SidedInventory {

    var generator: BlockGenerator
    var block: Block
    var rate: Float

    constructor(pos: BlockPos, state: BlockState): super(BlockEntityCompendium.BLOCK_GENERATOR, pos, state) {
        this.generator = BlockCompendium.COBBLESTONE_GENERATOR_MK1
        this.block = Blocks.COBBLESTONE
        this.rate = 0.01f
    }

    constructor(generator: BlockGenerator, block: Block, rate: Float, pos: BlockPos, state: BlockState): super(BlockEntityCompendium.BLOCK_GENERATOR, pos, state) {
