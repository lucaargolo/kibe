...
object BlockCompendium : RegistryCompendium<Block>(Registries.BLOCK) {
    ...
    val BLOCK_GENERATORS by registerTag("block_generators") { arrayOf(
    ...
    val ELEVATORS by registerAssociatedTag("elevators") { arrayOf(
    ...
    val MAGNET_INHIBITOR by registerTag("magnet_inhibitor", mutableListOf(ConventionalBlockTags.STORAGE_BLOCKS_COAL))
