...
class BreakerScreenHandler(syncId: Int, val playerInventory: PlayerInventory, val entity: BreakerBlockEntity, private val context: ScreenHandlerContext): ScreenHandler(ScreenHandlerCompendium.BREAKER, syncId)  {
    ...
    override fun canUse(player: PlayerEntity): Boolean {
        return context.get({ world: World, blockPos: BlockPos ->
            if (world.getBlockState(blockPos).block != BlockCompendium.BREAKER) false
